...
const index = async (req, res) => {
  try {
    const items = await db.AttendanceRecord.findAll();
...
const show = async (req, res) => {
  try {
    const item = await db.AttendanceRecord.findByPk(req.params.id);
...
const store = async (req, res) => {
  try {
    ...
    const item = await db.AttendanceRecord.create(payload);
